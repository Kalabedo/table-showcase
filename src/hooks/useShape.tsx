...
function getCirclePoints(radius: number = 1, segments: number = 128): Vector2[] {
...
function getRoundedRectPoints(length: number = 2, width: number = 1, radius: number = 0.05, cornerSegments: number = 32): Vector2[] {
  const points: Vector2[] = [];
